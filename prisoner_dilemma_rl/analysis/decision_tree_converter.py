...
- Imports heavy libraries only inside methods to avoid multiprocessing memory issues
"""
import logging
...
class DecisionTreeConverter:
    ...
    def convert_nn_to_decision_tree(self, neural_network: any, input_data: np.ndarray, agent_choices: List[str]):
        """
        ...
        """
        try:
            from sklearn.tree import DecisionTreeClassifier  # Heavy import moved here
    ...
    def summarize_tree(self, feature_names: List[str]) -> str:
        ...
        try:
            from sklearn.tree import export_text  # Heavy import moved here
